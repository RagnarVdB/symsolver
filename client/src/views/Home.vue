      ...
      navigation: [
        {
          ...
          info: 'Calculate single and multiple integrals. Fast and easy',
...
@font-face {
  ...
  src: url("../assets/WhyteInktrap-Regular.woff2");
  font-weight: 400;
  font-display: swap;
}
...
@font-face {
  font-family: Whyte;
  src: url("../assets/Whyte-Regular.woff2");
  font-weight: 400;
  font-display: swap;
}
...
@font-face {
  font-family: Whyte;
  src: url("../assets/Whyte-Bold.woff2");
  font-weight: 700;
  font-display: swap;
}
